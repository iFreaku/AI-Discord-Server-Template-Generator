...
async def generate_template(interaction: discord.Interaction, prompt: str):
    ...
    List of special characters to use when creating aesthetic or grudge themed servers (You can even combine different characters, eg: 「★」, and no need to give space/hyphen after special characters or emojis only between words! ):
